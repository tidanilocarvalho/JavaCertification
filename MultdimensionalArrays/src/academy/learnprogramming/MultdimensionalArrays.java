...
/**
 * one-dimension
 * asymmetrical two-dimensional array
 * three-dimensional array
 *
 * java is row major, rows go first
 *
 */
public class MultdimensionalArrays {
    ...
    public static void main(String[] args) {
        ...
        numberTable[0][1] = 2;
        numberTable[0][2] = 3;
        // numberTable[0][3] = 4; // throws exception out of bounds
        ...
        int anotherThreeArray[][][]; // do not use this
